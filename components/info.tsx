...
const Info = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <Image src={mezcal} className="w-[300px] md:w-[400px] h-auto mt-10" alt="Puro Mezcal" />
      ...
      <Image src={familia} className="w-[300px] md:w-[400px] h-auto mt-10" alt="En Familia" />
      ...
      <Image src={banda} className="w-[300px] md:w-[600px] h-auto mt-10" alt="Nosotros en Banda" />
    </div>
  );
};
