...
const Info = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <img src={mezcal.src} className="w-[300px] md:w-[400px] h-auto mt-10" />
      ...
      <img src={familia.src} alt="familia" className="w-[300px] md:w-[400px] h-auto mt-10" />
      ...
      <img src={banda.src} alt="banda" className="w-[300px] md:w-[600px] h-auto mt-10" />
    </div>
  );
};
