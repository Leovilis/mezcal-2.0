...
const dataFooter = [
  ...
  },
  {
    ...
    name: "Facebook",
    icon: Facebook,
    link: "https://www.facebook.com/share/1CFx3DL74g/"
  },
  {
    id: 3,
    name: "Contactos",
    icon: WhatsAppIcon,
    link: "https://wa.me/5491144773729"
  }
]
    ...
    <div className="mt-4">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            {dataFooter.map((data) => {
              ...
              return (
                <li key={data.id} className="flex justify-between">
                  <Link href={data.link} className="hover:underline p-6 mx-4 md:mx-6">
                    <Icon />
                  </Link>
                </li>
              )
        ...
        <span className="block text-sm text-gray-500 text-center mt-2 dark:text-gray-400">
          &copy; 2024
          <Link className="text-center mt-2" href={"/"}>{" "}LeoDev. </Link>Todos los derechos reservados.
        </span>
      </div>
    </div>
  )
